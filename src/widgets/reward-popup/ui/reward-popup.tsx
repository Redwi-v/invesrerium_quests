			...
			<div className='max-md:h-full max-md:flex max-md:flex-col max-md:justify-center max-md:items-center max-md:text-center max-md:w-full'>
				<div className='container !px-0'>
					...
					<div className='flex gap-2 mt-6 w-full'>
						<div className='bg-tone/100 bg-opacity-20 rounded-2xl py-[14px] px-3 flex w-full justify-between items-center'>
						...
						<div className='bg-tone/100 bg-opacity-20 rounded-2xl py-[14px] px-4 flex w-full justify-between items-center'>
