...
export { StarIcon } from './ui/star';
export { CrossIcon } from './ui/cross';

export { BurgerMenu } from './ui/burger-menu';
export { ProfileIcon } from './ui/profile';
export { SettingsIcon } from './ui/settings';
export { PeoplesIcon } from './ui/peoples';
export { HeartIcon } from './ui/heart';
export { SwitchIcon } from './ui/switch';
export { DisconnectIcon } from './ui/disconnect';

export { CircleIcon } from './ui/circle';
export { FireIcon } from './ui/fire';
