...
const ProfilePageEditView: FC<IProfilePageEditViewProps> = props => {
	...
	return (
		<div className='mt-[42px] bottom-[62px] max-xl:bottom-[42px] max-md:mt-[24px]'>
			<div className='container !max-w-[857px] min-[1024px]:p-0'>
              ...
              '
				...
				<ul className='mt-6 pb-[62px] max-xl:pb-[42px] flex gap-6 max-md:grid max-md:grid-cols-2 max-md:gap-3'>
