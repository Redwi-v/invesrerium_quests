	...
	return (
		<>
			<div className={`container `}>
				<div className='flex relative gap-6 pt-6 pb-[62px] max-xl:pb-[42px]'>
					<div
						ref={ref => {
					...
					>
						<div className='max-md:!overflow-auto '>
							...
							<div
								...
								min-h-[728px] rounded-[32px] px-[82px] py-[80px] justify-center
						 		items-center text-center max-xl:p-6 overflow-hidden
								max-md:top-0 max-md:bg-transparent  max-xl:pt-[87.5px] max-lg:pt-[24px]
						...
						items-center max-xl:grid max-xl:grid-cols-2 
						max-xl:grid-rows-2 max-xl:gap-0  max-xl:mt-0
						max-xl:auto-rows-min max-md:mt-auto max-md:pb-3 ${
							questIsOpen && windowSize.width < 768 && 'container'
						}`}
							>
								<Button
									color='gray'
									onClick={prevStep}
									className='  flex items-center !py-[12px] gap-2 !max-w-[175px] w-full max-xl:!max-w-[120px] max-xl:row-start-2'
								>
									<ArrowIcon className='w-6 h-6' />
									<span className='text-base'>Prev</span>
								</Button>
								<div className='flex w-full gap-2 max-xl:col-span-2'>
								...
								<div className='flex gap-2 !max-w-[175px] w-full justify-end max-xl:row-start-2 ml-auto'>
									<Button
										color='gray'
										onClick={nextStep}
									...
									<Button
										color='purple'
										onClick={nextStep}
										className='flex items-center text-base !px-[10px] !py-[12px] !pl-[18px] gap-2 !max-w-[175px] w-full max-xl:!max-w-[120px]'
									>
										Next
					...
					<div className=' w-full max-w-[416px] max-xl:max-w-[388px] max-lg:max-w-[276px] max-md:max-w-none'>
